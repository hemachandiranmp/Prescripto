...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-5 py-8 border radius w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <button type='submit' className='bg-blue-500 text-white px-10 py-3 mt-4 rounded-full'>Add Doctor</button>
      </div>
    </form>
  )
}
