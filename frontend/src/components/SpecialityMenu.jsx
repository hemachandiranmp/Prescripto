...
const SpecialityMenu = () => {
  return (
        ...
        <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of trusted doctor,<br className='hidden sm:block'/>scheduled your appoinment hassle-free.</p>

            <div className='flex sm:justify-center gap-4 overflow-x-auto pt-5 w-full overflow-scroll'>
